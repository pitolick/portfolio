...
1. Download and install [Sell Media](http://graphpaperpress.com/plugins/sell-media/) (included in the purchase of this them).
2. Configure Sell Media by following the [official documentation](http://graphpaperpress.com/docs/sell-media/).
